...
const About = () => {
 ...
 <div className="relative">
       ...
       <div className='flex flex-row gap-20 bg-orange-500'>
        <div>
          <h3 className='text-2xl p-14 font-bold'>Subscribe to our newsletter and we’ll keep you up to date on <br /> our products and services</h3>
        </div>
        <div className='p-14'>
          <label>
            <input 
            ...
            />
            <button className='bg-yellow-400  h-14 w-14 text-white py-2 px-6 rounded-r-full hover:bg-yellow-800 '>  → </button>
          </label>
        </div>
       </div>
      </div>
