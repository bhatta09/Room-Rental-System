...
const AboutUs = () => {
  return (
    <div className="bg-cover bg-center bg-fixed overflow-hidden w-full bg-about-pattern rounded-lg flex flex-col md:flex-row items-center gap-14 p-12 py-6 lg:px-32 ">
      <div className="my-16">
        <h2 className="text-2xl font-bold text-gray-100 mb-4">About Us</h2>
        <p className="text-gray-100 font-medium tracking-normal leading-6">
        ...
        <div className="flex justify-end">
          <button className="mt-4 px-6 py-2 bg-yellow-400 text-white rounded-md hover:bg-yellow-700 transition duration-300 font-medium">
