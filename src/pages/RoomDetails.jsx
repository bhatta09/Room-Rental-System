        ...
        <div className="col-span-3 bg--400 border p-6 shadow-lg ">
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-5 gap-8 ">
              <div>
                <h4 className=" text-sm font-medium text-gray-500 ">Room Id</h4>
            ...
            <div>
              ...
              <section className="text-sm">
                <p className="text-gray-700 mb-4">
                  Imagine yourself in the perfect villa – your private abode in
                  an elegant enclave, with all the finest of amenities and
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  in an exquisite 50 ropani community blessed with a full range
                  of facilities and spectacular terrace views. Karyabinayak
                  Homes is a balance of classic architecture and world-class
                  comforts designed to offer the ideal villa in Kathmandu.
                </p>

                <h2 className="text-sm font-bold text-gray-800 mt-6">Phases</h2>
                <ul className="list-disc list-inside text-gray-700 mt-4">
                  ...
                  <li>
                    <span className="font-semibold">Phase II:</span> Plan for 51
                    units. Bookings open! 2 units are already booked.
                  </li>
                </ul>
                ...
                <ul className="list-disc list-inside text-gray-700 mt-4">
                  <li>2.5 Storey</li>
                  <li>4 Bedroom (2 Master Bedrooms with attached bathrooms)</li>
                  <li>1 Living Room</li>
                  <li>1 Dining Room</li>
                  <li>1 Kitchen</li>
                  <li>4 Bathrooms</li>
          ...
          <div className="mb-10">
            <h1 className=" text-xl font-semibold border-b pb-2 mb-4">Media</h1>
            <div>
              <LazyLoadImage
                effect="blue"
                src="https://images.pexels.com/photos/276724/pexels-photo-276724.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
